import { AddCircleOutlineOutlined, AttachMoney, BarChart, ChatBubbleOutline, DynamicFeed, LineStyle, MailOutline, PermIdentity, Report, Storefront, Timeline, TrendingUp, WorkOutline } from '@material-ui/icons';
                ...
                <div className="sidebarMenu">
                    ...
                    <ul className="sidebarList">
                        ...
                        <Link to='/newproduct' className='link'>
                            <li className="sidebarListItem">
                                <AddCircleOutlineOutlined  className='sidebarIcon'/>Add Product
                            </li>
                        </Link>
                    </ul>
                </div>
